...
import com.galvarez.ttw.model.map.*;
...
public final class DestinationSystem extends EntitySystem {
    ...
    protected void inserted(Entity e) {
        ...
        if (!ai.has(e))
            ...
            notifications.addNotification(() -> screen.select(e, true), () -> !needDestination(e),
                    Icon.FLAG, "Select destination for %s...", names.get(e));
    }
            ...
            if (++dest.progress >= dest.turnsToMove) {
                ...
                if (dest.path.isEmpty()) {
                    ...
                    if (!ai.has(e)) {
                        ...
                        notifications.addNotification(() -> screen.select(e, true), null,
                                Icon.FLAG, "Finished moving %s!", names.get(e));
                    }
